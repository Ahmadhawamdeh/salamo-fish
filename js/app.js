...
var Seattle = new Store('Seattle', 3, 15, 4.7);
var Tokyo = new Store('Tokyo', 3, 27, 1.6);
var Dubai = new Store('Dubai', 10, 33, 3.8);
var Paris = new Store('Paris', 17, 35, 2.3);
var Lima = new Store('Lima', 22, 57, 6.3);
